/*
 * env-spawn-test.js: Tests for supporting environment variables in the tinyforever module
 *
...
vows.describe('tinyforever/monitor/spawn-options').addBatch({
    ...
    "an instance of tinyforever.Monitor with valid options": {
      "passing environment variables to env-vars.js": {
        topic: function () {
          ...
          child = new (tinyforever.Monitor)(path.join(__dirname, 'examples', 'env-vars.js'), {
            max: 1,
            silent: true,
            minUptime: 0,
            env: this.env
      ...
      "passing a custom cwd to custom-cwd.js": {
        topic: function () {
          ...
          child = new (tinyforever.Monitor)(path.join(__dirname, 'examples', 'custom-cwd.js'), {
            max: 1,
            silent: true,
            minUptime: 0,
            cwd: this.cwd
      ...
      "setting `hideEnv` when spawning all-env-vars.js": {
        topic: function () {
          ...
          child = new (tinyforever.Monitor)(path.join(__dirname, 'examples', 'all-env-vars.js'), {
            max: 1,
            silent: true,
            minUptime: 0,
